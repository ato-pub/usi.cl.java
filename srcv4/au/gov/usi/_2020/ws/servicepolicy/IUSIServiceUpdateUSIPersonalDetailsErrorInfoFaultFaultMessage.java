...
public class IUSIServiceUpdateUSIPersonalDetailsErrorInfoFaultFaultMessage extends Exception {
    ...
    public IUSIServiceUpdateUSIPersonalDetailsErrorInfoFaultFaultMessage(String message, au.gov.usi._2020.ws.ArrayOfErrorInfo arrayOfErrorInfo, java.lang.Throwable cause) {
        super(message, cause);
        this.arrayOfErrorInfo = arrayOfErrorInfo;
    }

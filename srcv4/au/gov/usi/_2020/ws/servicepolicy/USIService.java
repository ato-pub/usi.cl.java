...
public class USIService extends Service {
    ...
    static {
        URL url = USIService.class.getResource("srcv4/META-INF/wsdl/UsiService_CLIENT.wsdl");
        if (url == null) {
            url = USIService.class.getClassLoader().getResource("srcv4/META-INF/wsdl/UsiService_CLIENT.wsdl");
        }
        if (url == null) {
            java.util.logging.Logger.getLogger(USIService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "srcv4/META-INF/wsdl/UsiService_CLIENT.wsdl");
        }
        WSDL_LOCATION = url;
    }
